...
fg.config(["fgConfigProvider", "FgField", function (fgConfigProvider, FgField) {
  ...
  var categories = {
    ...
    'Utility input fields': [
      ...
      new FgField('timePicker',{
        displayName: 'TimePicker'
      }),
      new FgField('inputFile',{
  ...
  fgConfigProvider.validation.pattern({
    ...
    'Password': '(?=.*\\d)(?=.*[!@#$%^&*\\-=()|?.\"\';:]+)(?![.\\n])(?=.*[A-Z])(?=.*[a-z]).*$',
    'Date format one': 'dd-MMMM-yyyy',
    'Date format two': 'yyyy/MM/dd',
    'Date format three': 'dd.MM.yyyy',
    'Date format four': 'M!/d!/yyyy',
    'Date format five': 'shortDate'
  });
}]);
...
angular.module('fg').run(['$templateCache', function($templateCache){
  $templateCache.put('angular-form-gen/edit/edit.ng.html', '<div class=\"fg-edit row form-group\" ng-form=\"$fg\"><div class=\"col-sm-3\" ng-form=\"$palette\" fg-null-form=\"\"><div fg-form=\"\" fg-edit-palette=\"\" fg-no-render=\"true\"></div></div><div class=\"col-sm-9\"><div fg-form=\"\" fg-edit-canvas=\"\" fg-no-render=\"true\"></div></div></div>');
  ...
  $templateCache.put('angular-form-gen/edit/canvas/canvas.ng.html', '<div class=\"fg-edit-canvas builder-sdc-hide\" ng-class=\"{ \'fg-edit-canvas-dragging\': dragging }\"><div class=\"fg-edit-canvas-area\" dq-drag-area=\"fg-edit-canvas\" dq-drag-enter=\"canvasCtrl.dragEnter()\" dq-drag-leave=\"canvasCtrl.dragLeave()\" dq-drop=\"canvasCtrl.drop()\"><div ng-if=\"!(schema.fields.length)\"></div><div ng-repeat=\"field in schema.fields\"><div ng-class=\"{ \'fg-drag-placeholder-visible\' : dragPlaceholder.visible && dragPlaceholder.index === $index }\" class=\"fg-drag-placeholder\"></div><div fg-edit-canvas-field=\"\"></div></div><div ng-class=\"{ \'fg-drag-placeholder-visible\': dragPlaceholder.visible && dragPlaceholder.index == schema.fields.length }\" class=\"fg-drag-placeholder\"></div></div></div>');
  $templateCache.put('angular-form-gen/edit/palette/palette.ng.html', '<div class=\"fg-edit-palette builder-sdc-show\"><fieldset><div fg-edit-palette-categories=\"\" data-category=\"selectedCategory\"></div><div ng-repeat=\"template in templates | filter:templateFilter\" class=\"fg-field\" dq-draggable=\"fg-edit-canvas\" dq-drag-begin=\"{ source: \'palette\', field: template }\"><div class=\"fg-field-overlay\"><div class=\"btn-toolbar btn-toolbar-right\"><button class=\"btn btn-default btn-xs btn-primary\" type=\"button\" ng-click=\"schemaCtrl.addField(template)\" title=\"Add this field.\"><span class=\"glyphicon glyphicon-plus\"></span></button></div></div><div fg-field=\"template\" fg-tab-index=\"-1\" fg-no-validation-summary=\"true\" fg-edit-mode=\"true\"></div></div></fieldset></div>');

  $templateCache.put('angular-form-gen/field-templates/default/checkbox.ng.html', '<button class=\"btn btn-block green sdc-show\">{{field.schema.name}}</button><div class=\"md-checkbox sdc-hide\"><input readonly fg-field-input=\"\" id=\"{{ field.$_id }}\" type=\"checkbox\" tabindex=\"{{ tabIndex }}\" ng-model=\"form.data[field.schema.name]\" class="md-check"><label ng-if=\"field.schema.nolabel\" for=\"{{ field.$_id }}\"><span></span><span class=\"check\"></span><span class=\"box\"></span> {{ field.schema.displayName }}</label></div>');
  $templateCache.put('angular-form-gen/field-templates/default/checkboxlist.ng.html', '<button class=\"btn btn-block green sdc-show\">{{field.schema.name}}</button><div class=\"md-checkbox sdc-hide\" ng-repeat=\"(key, option) in field.schema.options\"><input readonly fg-field-input=\"\" type=\"checkbox\" tabindex=\"{{ tabIndex }}\" name=\"{{ field.schema.name }}[]\" value=\"{{ option.value }}\" ng-model=\"form.data[field.schema.name][option.value]\" id=\"{{ field.schema.name +  key }}\" class="md-check"><label title=\"{{ field.schema.tooltip }}\" for=\"{{ field.schema.name +  key }}\"><span></span><span class=\"check\"></span><span class=\"box\"></span> {{option.text || option.value}}</label></div>');
  $templateCache.put('angular-form-gen/field-templates/default/dropdownlist.ng.html', '<button class=\"btn btn-block green sdc-show\">{{field.schema.name}}</button><div class="sdc-hide" fg-field-input=\"\" fg-dropdown-input=\"field.schema.options\" title=\"{{ field.schema.tooltip }}\" id=\"{{ field.$_id }}\" ng-model=\"form.data[field.schema.name]\" ng-required=\"field.schema.validation.required\" tabindex=\"{{ tabIndex }}\" placeholder=\"{{ field.schema.placeholder }}\" ng-minlength=\"{{ field.schema.validation.minlength }}\" ng-maxlength=\"{{ field.schema.validation.maxlength }}\" ng-pattern=\"{{ field.schema.validation.pattern }}\" ng-disabled=\"isDisabled(field.schema)\"></div>');
  $templateCache.put('angular-form-gen/field-templates/default/email.ng.html', '<button class=\"btn btn-block green sdc-show\">{{field.schema.name}}</button><input readonly class=\"form-control sdc-hide\" fg-field-input=\"\" type=\"email\" id=\"{{ field.$_id }}\" title=\"{{ field.schema.tooltip }}\" tabindex=\"{{ tabIndex }}\" placeholder=\"{{ field.schema.placeholder }}\" ng-model=\"form.data[field.schema.name]\" ng-required=\"field.schema.validation.required\" ng-minlength=\"{{ field.schema.validation.minlength }}\" ng-maxlength=\"{{ field.schema.validation.maxlength }}\" ng-pattern=\"{{ field.schema.validation.pattern }}\" ng-disabled=\"isDisabled(field.schema)\">');
  $templateCache.put('angular-form-gen/field-templates/default/not-in-cache.ng.html', '<div class=\"fg-field-not-in-cache alert alert-error sdc-hide\"><p>No template registered in cache for field type \"{{ field.type }}\".</p></div>');
  $templateCache.put('angular-form-gen/field-templates/default/number.ng.html', '<button class=\"btn btn-block green sdc-show\">{{field.schema.name}}</button><input readonly class=\"form-control sdc-hide\" fg-field-input=\"\" fg-input-number=\"\" type=\"text\" id=\"{{ field.$_id }}\" title=\"{{ field.schema.tooltip }}\" tabindex=\"{{ tabIndex }}\" placeholder=\"{{ field.schema.placeholder }}\" min=\"{{ field.schema.validation.min }}\" max=\"{{ field.schema.validation.max }}\" ng-model=\"form.data[field.schema.name]\" ng-required=\"field.schema.validation.required\" ng-minlength=\"{{ field.schema.validation.minlength }}\" ng-maxlength=\"{{ field.schema.validation.maxlength }}\" ng-pattern=\"{{ field.schema.validation.pattern }}\" ng-disabled=\"isDisabled(field.schema)\">');
  $templateCache.put('angular-form-gen/field-templates/default/password.ng.html', '<button class=\"btn btn-block green sdc-show\">{{field.schema.name}}</button><input readonly class=\"form-control sdc-hide\" fg-field-input=\"\" type=\"password\" id=\"{{ field.$_id }}\" title=\"{{ field.schema.tooltip }}\" tabindex=\"{{ tabIndex }}\" placeholder=\"{{ field.schema.placeholder }}\" ng-model=\"form.data[field.schema.name]\" ng-required=\"field.schema.validation.required\" ng-minlength=\"{{ field.schema.validation.minlength }}\" ng-maxlength=\"{{ field.schema.validation.maxlength }}\" ng-pattern=\"{{ field.schema.validation.pattern }}\" ng-disabled=\"isDisabled(field.schema)\">');
  $templateCache.put('angular-form-gen/field-templates/default/radiobuttonlist.ng.html', '<button class=\"btn btn-block green sdc-show\">{{field.schema.name}}</button><div class=\"md-radio sdc-hide\" ng-repeat=\"option in field.schema.options\"><input readonly id=\"{{ field.schema.name + option.value }}\" class=\"md-radiobtn\" fg-field-input=\"\" type=\"radio\" name=\"{{ field.schema.name }}[]\" tabindex=\"{{ tabIndex }}\" value=\"{{ option.value }}\" ng-model=\"form.data[field.schema.name]\"><label for=\"{{ field.schema.name + option.value }}\" title=\"{{ field.schema.tooltip }}\"><span class=\"inc\"></span><span class=\"check\"></span><span class=\"box\"></span> {{option.text || option.value}}</label></div>');
  $templateCache.put('angular-form-gen/field-templates/default/selectlist.ng.html', '<button class=\"btn btn-block green sdc-show\">{{field.schema.name}}</button><select readonly class=\"form-control sdc-hide\" fg-field-input=\"\" id=\"{{ field.$_id }}\" title=\"{{ field.schema.tooltip }}\" ng-model=\"form.data[field.schema.name]\" ng-required=\"field.schema.validation.required\" tabindex=\"{{ tabIndex }}\"><option ng-repeat=\"option in field.schema.options\" value=\"{{ option.value }}\" ng-selected=\"form.data[field.schema.name] === option.value\">{{ option.text || option.value }}</option></select>');

  $templateCache.put('angular-form-gen/field-templates/default/text.ng.html', '<button class=\"btn btn-block green sdc-show\">{{field.schema.name}}</button><input readonly class=\"form-control sdc-hide\" fg-field-input=\"\" type=\"text\" id=\"{{ field.$_id }}\" title=\"{{ field.schema.tooltip }}\" tabindex=\"{{ tabIndex }}\" placeholder=\"{{ field.schema.placeholder }}\" ng-model=\"form.data[field.schema.name]\" ng-required=\"field.schema.validation.required\" ng-minlength=\"{{ field.schema.validation.minlength }}\" ng-maxlength=\"{{ field.schema.validation.maxlength }}\" ng-pattern=\"{{ field.schema.validation.pattern }}\" ng-disabled=\"isDisabled(field.schema)\">');

  $templateCache.put('angular-form-gen/field-templates/default/heading.ng.html', '<button class=\"btn btn-block green sdc-show\">{{field.schema.name}}</button><div class=\"sdc-heading sdc-hide\"><h2>{{ fieldSchema.displayName }}</h2><hr /></div>');

  $templateCache.put('angular-form-gen/field-templates/default/datePicker.ng.html', '<button class=\"btn btn-block green sdc-show\">{{field.schema.name}}</button><directive-datepicker class="sdc-hide"><p class=\"input-group\"><input readonly type=\"text\" class=\"form-control\" uib-datepicker-popup=\"{{ field.schema.validation.pattern }}\" ng-model=\"form.data[field.schema.name]\" is-open=\"date.popup.opened\" datepicker-options=\"date.dateOptions\"  close-text=\"Close\" tabindex=\"{{ tabIndex }}\" /><span class=\"input-group-btn\"><button type=\"button\" class=\"btn btn-default\" ng-click=\"date.open()\"><i class=\"glyphicon glyphicon-calendar\"></i></button></span></p></directive-datepicker>');

  $templateCache.put('angular-form-gen/field-templates/default/timePicker.ng.html', '<button class=\"btn btn-block green sdc-show\">{{field.schema.name}}</button><directive-time-picker class="sdc-hide"><uib-timepicker ng-model=\"vm.formData.mytime[field.schema.name]\" ng-change=\"time.changed(field.schema.name)\" hour-step="time.hstep" minute-step="time.mstep" show-meridian="time.ismeridian"></uib-timepicker></directive-time-picker>');

  $templateCache.put('angular-form-gen/field-templates/default/inputFile.ng.html', '<button class=\"btn btn-block green sdc-show\">{{field.schema.name}}</button><div class=\"sdc-hide\"><input disabled type=\"file\" class=\"form-control\"></div>');

  $templateCache.put('angular-form-gen/field-templates/default/textarea.ng.html', '<button class=\"btn btn-block green sdc-show\">{{field.schema.name}}</button><textarea readonly class=\"form-control sdc-hide\" fg-field-input=\"\" fg-placeholder=\"field.schema.placeholder\" ng-model=\"form.data[field.schema.name]\" id=\"{{ field.$_id }}\" title=\"{{ field.schema.tooltip }}\" tabindex=\"{{ tabIndex }}\" ng-required=\"field.schema.validation.required\" ng-minlength=\"{{ field.schema.validation.minlength }}\" ng-maxlength=\"{{ field.schema.validation.maxlength }}\" ng-pattern=\"{{ field.schema.validation.pattern }}\">\n' + '</textarea>');

  $templateCache.put('angular-form-gen/field-templates/properties/checkbox.ng.html', '<div fg-tabs-pane=\"Properties\"><div fg-property-field-common=\"{ displayname: true }\"></div></div>');
  $templateCache.put('angular-form-gen/field-templates/properties/checkboxlist.ng.html', '<div fg-tabs-pane=\"Properties\"><div fg-property-field-common=\"{ displayname: true }\"></div></div><div fg-tabs-pane=\"Options\"><div fg-property-field-options=\"multiple\"></div></div>');
  $templateCache.put('angular-form-gen/field-templates/properties/dropdownlist.ng.html', '<div fg-tabs-pane=\"Properties\"><div fg-property-field-common=\"{ displayname: true, placeholder: true }\"></div><div fg-property-field-value=\"\"><div fg-field-input=\"\" fg-dropdown-input=\"field.options\" ng-model=\"field.value\" ng-minlength=\"{{ field.schema.validation.minlength }}\" ng-maxlength=\"{{ field.schema.validation.maxlength }}\" ng-pattern=\"{{ field.schema.validation.pattern }}\"></div></div></div><div fg-tabs-pane=\"Validation\"><div fg-property-field-validation=\"{ required: true, minlength: true, maxlength: true, pattern: true }\"></div></div>');
  $templateCache.put('angular-form-gen/field-templates/properties/email.ng.html', '<div fg-tabs-pane=\"Properties\"><div fg-property-field-common=\"{ displayname: true, placeholder: true }\"></div></div><div fg-tabs-pane=\"Validation\"><div fg-property-field-validation=\"{ required: true }\"></div></div>');
  $templateCache.put('angular-form-gen/field-templates/properties/number.ng.html', '<div fg-tabs-pane=\"Properties\"><div fg-property-field-common=\"{ displayname: true, placeholder: true }\"></div></div><div fg-tabs-pane=\"Validation\"><div fg-property-field-validation=\"{ required: true }\"></div></div>');
  $templateCache.put('angular-form-gen/field-templates/properties/password.ng.html', '<div fg-tabs-pane=\"Properties\"><div fg-property-field-common=\"{ displayname: true, placeholder: true }\"></div></div><div fg-tabs-pane=\"Validation\"><div fg-property-field-validation=\"{ required: true }\"></div></div>');
  $templateCache.put('angular-form-gen/field-templates/properties/radiobuttonlist.ng.html', '<div fg-tabs-pane=\"Properties\"><div fg-property-field-common=\"{ displayname: true }\"></div></div><div fg-tabs-pane=\"Options\"><div fg-property-field-options=\"\"></div></div>');
  $templateCache.put('angular-form-gen/field-templates/properties/selectlist.ng.html', '<div fg-tabs-pane=\"Properties\"><div fg-property-field-common=\"{ displayname: true}\"></div></div><div fg-tabs-pane=\"Options\"><div fg-property-field-options=\"\"></div></div>');

  $templateCache.put('angular-form-gen/field-templates/properties/text.ng.html', '<div fg-tabs-pane=\"Properties\"><div fg-property-field-common=\"{ displayname: true, placeholder: true }\"></div></div><div fg-tabs-pane=\"Validation\"><div fg-property-field-validation=\"{ required: true}\"></div></div>');

  $templateCache.put('angular-form-gen/field-templates/properties/heading.ng.html', '<div fg-tabs-pane=\"Properties\"><div fg-property-field-common=\"{ displayname: true }\"></div></div>');

  $templateCache.put('angular-form-gen/field-templates/properties/datePicker.ng.html', '<div fg-tabs-pane=\"Properties\"><div fg-property-field-common=\"{ displayname: true }\"></div></div><div fg-tabs-pane=\"Validation\"><div fg-property-field-validation=\"{ pattern: true }\"></div></div>');

  $templateCache.put('angular-form-gen/field-templates/properties/timePicker.ng.html', '<div fg-tabs-pane=\"Properties\"><div fg-property-field-common=\"{ displayname: true }\"></div></div>');

  $templateCache.put('angular-form-gen/field-templates/properties/inputFile.ng.html', '<div fg-tabs-pane=\"Properties\"><div fg-property-field-common=\"{ displayname: true }\"></div></div>');

  $templateCache.put('angular-form-gen/field-templates/properties/textarea.ng.html', '<div fg-tabs-pane=\"Properties\"><div fg-property-field-common=\"{ displayname: true, placeholder: true}\"></div></div><div fg-tabs-pane=\"Validation\"><div fg-property-field-validation=\"{ required: true }\"></div></div>');

  $templateCache.put('angular-form-gen/form/field/field.ng.html', '<div class=\"fg-field-inner form-group\" ng-class=\"{ \'fg-field-required\': fieldSchema.validation.required, \'has-error\': form.state[field.name].$invalid }\"><label ng-if=\"!field.schema.nolabel\" ng-show=\"field.schema.type !== \'heading\' \" class=\"col-sm-3 control-label\" for=\"{{ field.$_id }}\">{{ fieldSchema.displayName }}</label><div class=\"col-sm-9\" ng-class=\"{ \'col-sm-offset-3\': field.schema.nolabel }\"><div ng-include=\"renderInfo.templateUrl\"></div><div fg-validation-summary=\"\" fg-validation-messages=\"fieldSchema.validation.messages\" ng-if=\"!noValidationSummary\"></div></div></div>');
  $templateCache.put('angular-form-gen/form/form-fields/form-fields.ng.html', '<div class=\"fg-form-fields builder-sdc-hide\"><fieldset><div ng-repeat=\"field in form.schema.fields\"><div fg-field=\"field\"></div></div></fieldset></div>');
