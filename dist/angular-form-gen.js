...
angular.module('fg').run(['$templateCache', function($templateCache){
  ...
  $templateCache.put('angular-form-gen/field-templates/default/number.ng.html', '<button class=\"btn btn-block green sdc-show\">{{field.schema.name}}</button><input class=\"form-control sdc-hide\" fg-field-input=\"\" fg-input-number=\"\" type=\"text\" id=\"{{ field.$_id }}\" title=\"{{ field.schema.tooltip }}\" tabindex=\"{{ tabIndex }}\" placeholder=\"{{ field.schema.placeholder }}\" min=\"{{ field.schema.validation.min }}\" max=\"{{ field.schema.validation.max }}\" ng-model=\"form.data[field.schema.name]\" ng-required=\"field.schema.validation.required\" ng-minlength=\"{{ field.schema.validation.minlength }}\" ng-maxlength=\"{{ field.schema.validation.maxlength }}\" ng-pattern=\"{{ field.schema.validation.pattern }}\" ng-disabled=\"isDisabled(field.schema)\">');
  $templateCache.put('angular-form-gen/field-templates/default/password.ng.html', '<button class=\"btn btn-block green sdc-show\">{{field.schema.name}}</button><input class=\"form-control sdc-hide\" fg-field-input=\"\" type=\"password\" id=\"{{ field.$_id }}\" title=\"{{ field.schema.tooltip }}\" tabindex=\"{{ tabIndex }}\" placeholder=\"{{ field.schema.placeholder }}\" ng-model=\"form.data[field.schema.name]\" ng-required=\"field.schema.validation.required\" ng-minlength=\"{{ field.schema.validation.minlength }}\" ng-maxlength=\"{{ field.schema.validation.maxlength }}\" ng-pattern=\"{{ field.schema.validation.pattern }}\" ng-disabled=\"isDisabled(field.schema)\">');
  $templateCache.put('angular-form-gen/field-templates/default/radiobuttonlist.ng.html', '<button class=\"btn btn-block green sdc-show\">{{field.schema.name}}</button><div class=\"md-radio sdc-hide\" ng-repeat=\"option in field.schema.options\"><input id=\"{{ field.schema.name + option.value }}\" class=\"md-radiobtn\" fg-field-input=\"\" type=\"radio\" name=\"{{ field.schema.name }}[]\" tabindex=\"{{ tabIndex }}\" value=\"{{ option.value }}\" ng-model=\"form.data[field.schema.name]\"><label for=\"{{ field.schema.name + option.value }}\" title=\"{{ field.schema.tooltip }}\"><span class=\"inc\"></span><span class=\"check\"></span><span class=\"box\"></span> {{option.text || option.value}}</label></div>');
  $templateCache.put('angular-form-gen/field-templates/default/selectlist.ng.html', '<button class=\"btn btn-block green sdc-show\">{{field.schema.name}}</button><select class=\"form-control sdc-hide\" fg-field-input=\"\" id=\"{{ field.$_id }}\" title=\"{{ field.schema.tooltip }}\" ng-model=\"form.data[field.schema.name]\" ng-required=\"field.schema.validation.required\" tabindex=\"{{ tabIndex }}\"><option ng-repeat=\"option in field.schema.options\" value=\"{{ option.value }}\" ng-selected=\"form.data[field.schema.name] === option.value\">{{ option.text || option.value }}</option></select>');

  $templateCache.put('angular-form-gen/field-templates/default/text.ng.html', '<button class=\"btn btn-block green sdc-show\">{{field.schema.name}}</button><input class=\"form-control sdc-hide\" fg-field-input=\"\" type=\"text\" id=\"{{ field.$_id }}\" title=\"{{ field.schema.tooltip }}\" tabindex=\"{{ tabIndex }}\" placeholder=\"{{ field.schema.placeholder }}\" ng-model=\"form.data[field.schema.name]\" ng-required=\"field.schema.validation.required\" ng-minlength=\"{{ field.schema.validation.minlength }}\" ng-maxlength=\"{{ field.schema.validation.maxlength }}\" ng-pattern=\"{{ field.schema.validation.pattern }}\" ng-disabled=\"isDisabled(field.schema)\">');

  $templateCache.put('angular-form-gen/field-templates/default/datePicker.ng.html', '<button class=\"btn btn-block green sdc-show\">{{field.schema.name}}</button><directive-datepicker class="sdc-hide"><p class=\"input-group\"><input type=\"text\" class=\"form-control\" uib-datepicker-popup=\"{{ field.schema.validation.pattern }}\" ng-model=\"form.data[field.schema.name]\" is-open=\"date.popup.opened\" datepicker-options=\"date.dateOptions\"  close-text=\"Close\" tabindex=\"{{ tabIndex }}\" /><span class=\"input-group-btn\"><button type=\"button\" class=\"btn btn-default\" ng-click=\"date.open()\"><i class=\"glyphicon glyphicon-calendar\"></i></button></span></p></directive-datepicker>');
  ...
  $templateCache.put('angular-form-gen/field-templates/default/inputFile.ng.html', '<button class=\"btn btn-block green sdc-show\">{{field.schema.name}}</button><div class=\"row sdc-hide\"><div class=\"col-md-2 text-center\"><file-field ng-model=\"vm.formData.uploadFile[field.schema.name]\" preview=\"previewImage\">Select File</file-field></div><div class=\"col-md-6 input-img-preview\"><img ng-src=\"{{previewImage}}\" class=\"img-responsive\">{{vm.formData.uploadFile[field.schema.name].name}}</div></div>');

  $templateCache.put('angular-form-gen/field-templates/default/textarea.ng.html', '<button class=\"btn btn-block green sdc-show\">{{field.schema.name}}</button><textarea class=\"form-control sdc-hide\" fg-field-input=\"\" fg-placeholder=\"field.schema.placeholder\" ng-model=\"form.data[field.schema.name]\" id=\"{{ field.$_id }}\" title=\"{{ field.schema.tooltip }}\" tabindex=\"{{ tabIndex }}\" ng-required=\"field.schema.validation.required\" ng-minlength=\"{{ field.schema.validation.minlength }}\" ng-maxlength=\"{{ field.schema.validation.maxlength }}\" ng-pattern=\"{{ field.schema.validation.pattern }}\">\n' + '</textarea>');
